...
crates/
  mdeck/           # GUI binary (package and binary name: mdeck)
    ...
    build.rs         # Registers illustrations/*.mdpc as built-in point clouds (generated include_str! table)
    illustrations/   # Built-in point clouds (*.mdpc, generated with `mdeck illustration generate`)
    doc/
